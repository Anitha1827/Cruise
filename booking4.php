...
<div class="col-md-12 col-lg-12 mt-3">
	...
	<div class="col-md-3 col-sm shadow-sm p-3 mb-5 bg-white rounded">
		<div class="text-center">
			<h4 style="color:#061828">3 Night Ensenada Cruise</h4>
		</div>
		<br>
				<div class="ml-2">
					<label>Leaving from Los Angeles, California onboard Navigator of the Seas</label><br><br>
				<label>Dec 13, 2021<small><i class="fas fa-arrow-right text-muted"></i></small> Dec 16, 2021</label><br>
				...
				<div class="container">
				  ...
				  <tbody>
				    <tr>
				      <th scope="row"><img src="assets/image/icons/bed.png" width="25px"></th>
				      <td>Staterooms</td>
				    </tr>
            <tr scope="row">
              <td><b>Room</b></td>
	...
	<div class="col-md-9">
		<div class="mt-4 mb-3">
			<h2>Choose stateroom assignment</h2>
      <label>The flexibility you want - save by letting us assign your room prior to sailing, or have total <br>control to find your perfect room.</label>
		</div>
		<!-- pick room Section start -->
    <div class="card shadow mb-5 bg-white rounded">
  <h5 class="card-header bg-primary text-light p-4" style="font-size:25px;">We pick your room</h5>
  <div class="card-body">
    <div class="row">
      <div class="col-md-10 col-sm text-left">
      <p>We give you the best available stateroom in this category, based on availability, <br>assigned prior to sailing.</p>
    </div>
    <div class="col-md-2 cl-sm text-right">
      <small>From USD<small>*</small></small>
       <h1>$109</h1>
       <small>Person</small>
    </div>
    </div>
    ...
    <div class="text-right">
      <a href="detail.php" class="btn btn-primary px-3"><b>Select</b></a>
    </div>
  </div>
</div>
    <!-- Pick room section End -->
    <!--you Pick your room start-->
    <div class="card shadow mb-5 bg-white rounded">
  <h5 class="card-header text-light p-4" style="font-size:25px; background-color: #061556;">You pick your room</h5>
  <div class="card-body">
    <div class="row">
      <div class="col-md-10 col-sm text-left">
      <p>You choose your perfect room, including optional upgrades and flexible location.</p>
    </div>
    <div class="col-md-2 cl-sm text-right">
      <small>From USD<small>*</small></small>
       <h1>$120</h1>
     ...
     <hr>
    <div class="text-right">
      <a href="detail1.php" class="btn btn-primary px-3"><b>Select</b></a>
    </div>
  </div>
</div>
    <!-- you pick your room end -->

<!-- text content start -->
<div style="font-size: 12px;" class="mb-5">
